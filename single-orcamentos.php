...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>ConstruShopping | Orçamentos</title>
  ...
  <body>
    ...
    <div class="container meupainel">
      ...
      <div class="meupainel-container col-md-9 col-sm-9 col-xs-12">
        <div class="meupainel-titulo"><h1 class="text-center">Orçamentos</h1></div>
        ...
        <div class="propostasenviadas panel panel-info">          
          ...
          <div class="panel-body">
            <div class="col-md-7">
              ...
              <div class="escopo"><i class="fa fa-user-circle-o" aria-hidden="true"></i>Salvador</div>
              <div class="escopo"><i class="fa fa-user-circle-o" aria-hidden="true"></i>EGP</div>
              <div class="escopo"><i class="fa fa-user-circle-o" aria-hidden="true"></i>Custo Benefício</div>
