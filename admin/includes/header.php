...
// seleciona a usuario logado
		$selecionaLogado = "SELECT * from administrador WHERE usuario=:usuarioLogado AND senha=:senhaLogado";
		try{
...
<head>
<meta charset="utf-8">
<title>ConstruShopping - Área Administrativa</title>
