...
<head>
    <meta charset="utf-8">
    <title>Login - ConstruShopping</title>
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<a class="brand" href="index.php">
				ConstruShopping - Administrativo			
			</a>		
...
if(isset($_POST['logar'])){
		...
		//TRIM RETIRA OS ESPAÇOS E STRIP TAGS RETIRA TAGS HTML, PHP...
		$usuario = trim(strip_tags($_POST['usuario']));
		$senha	 = trim(strip_tags($_POST['senha']));
		
		// SELECIONAR BANCO DE DADOS
		//BINAY INDICA PARA O BANCO QUE QUERERMOS RECEBER DADOS CASE SENSITIVE
		$select = "SELECT * from administrador WHERE BINARY usuario=:usuario AND BINARY senha=:senha ";
