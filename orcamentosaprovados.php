...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>ConstruShopping | Orçamentos Aprovados</title>
  ...
  <body>
    ...
    <div class="container meupainel">
      ...
      <div class="meupainel-container col-md-9 col-sm-9 col-xs-12">
        <div class="meupainel-titulo"><h1 class="text-center">Orçamentos Aprovados</h1></div>
        ...
        <?php
          ...
          WHERE cadastrocliente.id_cadastro_cliente = $cliente_id_logado AND orcamento.status = 'Aprovado' LIMIT 2 ");
          ...
          try{
            ...
            if(isset($_GET['pagina']) == $i){
              ...
              $ver_orcamento = $pdo->query("SELECT * FROM orcamento INNER JOIN cadastrocliente 
              ON cadastrocliente.id_cadastro_cliente = orcamento.fk_id_cadastro_cliente 
              WHERE cadastrocliente.id_cadastro_cliente = $cliente_id_logado AND orcamento.status = 'Aprovado' LIMIT 2 OFFSET $mody");
            }
            //PAGINAÇÃO  
